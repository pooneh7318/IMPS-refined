...
def build_model(seq_len=30, hidden_units=256, num_mixtures=5, layers=2,
    ...
    if compile_model:
        ...
        optimizer = tf.keras.optimizers.SGD(lr=0.0005, decay=0.0005/130, momentum=0.8, nesterov=False)
        # lr=0.005, decay=0.005/130, momentum=0.8, nesterov=False
        # momentum=0.8, decay=0, nesterov=False
